...
final class TabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    private func setupTabbar() {
        ...
        repoListVC.viewControllers = [RepositoryListViewController(title: "Repositories".localized,
